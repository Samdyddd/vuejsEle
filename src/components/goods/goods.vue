<template>
  <div class="goods">
    <div class="menu-wrapper" ref="menuWrapper">
      <ul>
        <li v-for="(item,index) in goods" class="muen-item muen-item-hook" :class="{'current':currentIndex === index}">
          <span class="text border-1px" @click='selectList(index,$event)'>
  ...
  export default{
    ...
    watch: {
      currentIndex: function (index) {
        let menuList = this.$refs.menuWrapper.getElementsByClassName('muen-item-hook');
