<template>
  <div class="ratingselect">
    ...
    <div @click="toggleswitch($event)" class="switch" :class="{'on':onlyContent}">
...
<script type="text/ecmascript-6">
  ...
  export default{
    ...
    methods: {
      ...
      toggleswitch(event) {
        this.onlytoggle = !this.onlytoggle;
        this.$emit('toggle-onlycontent', this.onlytoggle);
      }
    }
  };
</script>
